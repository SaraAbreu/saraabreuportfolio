      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
          ...
          >
            ...
            >
              <div className="w-full max-w-md h-56 rounded-2xl overflow-hidden shadow-lg border-2 border-rose-500/30">
                <video
                  src="/videos/agorademo.mp4"
            ...
            <h4 className="text-2xl font-bold text-white mb-3">App Ágora Mujeres</h4>
            <p className="text-rose-200/70 leading-relaxed mb-4">
              Una plataforma colaborativa diseñada para conectar, empoderar e inspirar a mujeres. Espacio seguro para compartir experiencias, ideas y oportunidades.
            </p>
            <div className="flex items-center gap-2">
              <a
                ...
                className="px-4 py-2 bg-rose-500/20 border border-rose-400/50 hover:bg-rose-500/30 text-rose-300 text-sm font-semibold rounded-lg transition-all duration-300 hover:scale-105 inline-flex items-center gap-2"
              >
                Visitar App
